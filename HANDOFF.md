...
**Solari** — one Klondike deal a day, guaranteed winnable.
Plan: `/Volumes/ExtremePro/Dev/next_mobile_apps/PLAN_2.md` (PLAN_2.md §2).
...
1. **Write the game.** Nothing of it exists yet — deck/deal, move rules, winnability search.
   The plan for this app is `next_mobile_apps/PLAN_2.md` (PLAN_2.md §2).
...
3. **Free tier**, as planned: archive last 7 days, unlimited undo behind the unlock.
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.solari` |
| Scheme | `solari://` |
| GitHub | `AltixCode/solari` |
| RevenueCat project | `proj87fde18c` |
| RevenueCat iOS app | `appc957594e0b` |
| RevenueCat Android app | `app5b4e0cdea5` |
| Entitlement | `remove_ads` (`entl9af6b50165`) |
| Offering / package | `default` (`ofrng3d6640239d`) / `$rc_lifetime` (`pkgeaacbddc3c7`) |
| AdMob app (iOS) | `ca-app-pub-2504845459806550~3216758025` |
| AdMob app (Android) | `ca-app-pub-2504845459806550~2761015348` |
...
Locally they come from `/Volumes/ExtremePro/Dev/mobile_expo_apps/.admob-ids/solari.env` —
...
- Shared code is generated. Fix it in `AltixCode/next-mobile-apps` (`_template/`)
  and re-run `node scripts/bootstrap.mjs solari`, never in this copy —
