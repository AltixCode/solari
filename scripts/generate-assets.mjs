#!/usr/bin/env node
/**
 * Generates every brand asset for Solari from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"rect","x":0.06,"y":0.14,"w":0.5,"h":0.72,"r":0.09,"fill":"accentMid"},{"type":"rect","x":0.3,"y":0.08,"w":0.56,"h":0.8,"r":0.1,"fill":"paper"},{"type":"poly","points":[[0.58,0.28],[0.76,0.48],[0.58,0.68],[0.4,0.48]],"fill":"accent"}];
 ...
 */
const MARK = [[1,1,1,0.45,0.12],[0.45,1,1,1,0.45],[0.12,0.45,1,1,1],[0.12,0.12,0.45,1,1],[0.12,0.12,0.12,0.45,1]];
...
console.log('Generating Solari brand assets\n');
