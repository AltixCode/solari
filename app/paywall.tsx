...
const BENEFITS = ["The full deal archive and unlimited replays","No ads, ever","Unlimited undo","Draw-1 and draw-3, plus Vegas scoring"];
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background, paddingTop: insets.top }}>
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.xl, paddingBottom: spacing['3xl'] }}>
        <Text variant="display">Solari Pro</Text>
        <Text variant="body" tone="muted" style={{ marginTop: spacing.sm }}>
          One Klondike deal a day. Guaranteed winnable. Same for everyone.
        </Text>
