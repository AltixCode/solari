...
section is in `/Volumes/ExtremePro/Dev/next_mobile_apps/PLAN_2.md`.
...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs solari`,
...
| iOS product | `com.altixcode.solari.removeads` |
